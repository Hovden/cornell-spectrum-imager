...
public class SpectrumData1D extends SpectrumData {

	/**
	 * @param csi_Spectrum_Analyzer
	 */
	SpectrumData1D(CSI_Spectrum_Analyzer csi_Spectrum_Analyzer, ImagePlus img) {
	...
	void PCA(int fitStart, int fitEnd, int pcaStart, int pcaEnd) {
		...
		PCAwindows PCAw = new PCAwindows(this.csi_Spectrum_Analyzer);
